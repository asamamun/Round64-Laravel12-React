                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" id="cost_price" name="cost_price" step="0.01" value="{{ old('cost_price') }}">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" id="length" name="length" step="0.01" value="{{ old('length') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="width" class="form-label">Width (cm)</label>
                                                        <input type="number" class="form-control" id="width" name="width" step="0.01" value="{{ old('width') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="mb-3">
